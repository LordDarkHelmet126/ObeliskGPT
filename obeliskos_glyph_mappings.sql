-- MUXEDIT Metadata: ScriptID=3s4t5u6v-7w8x-9y0z-1a2b-3c4d5e6f, Version=1.0, Author=LordDarkHelmet, Created=2025-05-08
-- Description: SQLite schema for Obelisk🜒 glyph mappings (Config F)
...
(4, '♌', 'Render Asset', 'Active', 'GENERAL', 6, '00000000100');
...
('Gaming', 2, '🔸', 'Mission Generate', 4, TRUE, 6),
